...
export const problems: Problem[] = [
  // ─────────────────────────── Приклад твоєї подруги ───────────────────────────
  {
    ...
    steps: [
      {
        ...
        help: {
          ...
          simpler:
            "Якщо тобі сказали «з'їж яблуко і грушу», ти ж не їси їх одночасно — спочатку одне, потім друге. Інтеграл суми так само: бери доданки по черзі.",
          examples: [
            {
          ...
          check: {
            question: "Як розбити ∫(x³ + x)dx на два інтеграли?",
            answer: "\\int x^3\\,dx + \\int x\\,dx",
          },
        },
      },
      {
      ...
      },
      {
        ...
        help: {
          plain:
            "Правило одне на всі степені: додай 1 до показника і поділи на нього.",
          simpler:
            "Два рухи й усе. Рух 1: показник угорі стає на 1 більший. Рух 2: на це нове число ділиш. Більше нічого робити не треба.",
          numeric: [
    ...
    methodIds: ["linearity", "table", "verify"],
    pitfalls: [
    ...
    steps: [
      ...
      },
      {
        ...
        help: {
          ...
          simpler:
            "Стале число = це x⁰ із множником (бо x⁰=1). За тим самим правилом степінь 0 стає 1: x⁰ → x¹ = x. Тому число просто отримує собі x.",
          numeric: [
            { latex: "\\int 5\\,dx = 5x", note: "до числа дописали x" },
            { latex: "(5x)' = 5", note: "перевірка: похідна вертає 5" },
          ],
          examples: [
            { latex: "\\int 7\\,dx = 7x", note: "будь-яке число a → a·x" },
          ],
          check: {
            question: "Чому дорівнює ∫3 dx?",
            answer: "3x + C",
          },
        },
      },
